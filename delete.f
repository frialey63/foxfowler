...
C     "INITIALISE ARRAYS AND SPECIAL VARIABLES"
      ...
      INTEGER ACCTNO, CODENO, SHEETN, BALDT, TRANDT, F
...
C     "FIND CUSTOMER"
   ...
   51 READ(4,52) BRNAME, ANAME, CODENO, SHEETN, BALFWD, BALDT, BALMTH
      DO 53 M=1,7
          I = 4
   ...
   54 WRITE(2,55) BANKYR
      WRITE(2,56) BRNAME, ANAME, CODENO, SHEETN, BALFWD, BALDT, BALMTH
   14 READ(4,10) TRANDT
      WRITE(2,60) TRANDT
...
C     "END OF FILE OLD, CHECK THE FOUND"
